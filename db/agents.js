...
exports.matchers = [
  ...
  [/^Downcast.+iPad/, 11, 36, 43],
  [/^Downcast.+iPhone/, 11, 36, 43],
  [/^Downcast.+iPod/, 11, 36, 43],
  [/^Downcast.+OS X/, 11, 35, 45],
  [/^Echo/, 3, 37, 44],
  [/^English.+Radio.+IELTS.+TOEFL.+CFNetwork/, 81, 36, 43],
  [/^(ExoPlayer.+Android|yourApplicationName.+Android.+ExoPlayer)/, null, 36, 42],
  [/^ExoMediaPlayer.+Android/, null, 36, 42],
  ...
  [/^AppleCoreMedia.+iPad/, 25, 36, 43],
  [/^AppleCoreMedia.+iPhone/, 25, 36, 43],
  [/^AppleCoreMedia.+iPod/, 25, 36, 43],
  ...
  [/^Mozilla\/5\.0.+Windows Phone.+Firefox/, 28, 40, 47],
  [/^Mozilla\/5\.0.+Windows Phone.+Chrome/, 29, 40, 47],
  [/^Mozilla\/5\.0.+Windows Phone.+IEMobile/, 26, 40, 47],
  [/^Mozilla\/5\.0.+Windows Phone/, null, 40, 47],
  [/^Mozilla\/5\.0.+Windows NT.+Firefox/, 28, 39, 41],
  [/^Mozilla\/5\.0.+Windows NT.+Chrome/, 29, 39, 41],
  [/^Mozilla\/5\.0.+Windows NT/, 26, 39, 41],
  [/^Mozilla\/5\.0.+iPad.+FxiOS/, 28, 40, 43],
  [/^Mozilla\/5\.0.+iPad.+CriOS/, 29, 40, 43],
  [/^Mozilla\/5\.0.+iPad.+FBAN/, 30, 36, 43],
  [/^Mozilla\/5\.0.+iPad.+Twitter/, 31, 36, 43],
  [/^Mozilla\/5\.0.+iPad.+AppleNews/, 32, 36, 43],
  [/^Mozilla\/5\.0.+iPad.+Safari/, 27, 40, 43],
  [/^Mozilla\/5\.0.+iPad/, null, 40, 43],
  [/^Mozilla\/5\.0.+iPhone.+FxiOS/, 28, 40, 43],
  [/^Mozilla\/5\.0.+iPhone.+CriOS/, 29, 40, 43],
  [/^Mozilla\/5\.0.+iPhone.+FBAN/, 30, 36, 43],
  [/^Mozilla\/5\.0.+iPhone.+Twitter/, 31, 36, 43],
  [/^Mozilla\/5\.0.+iPhone.+AppleNews/, 32, 36, 43],
  [/^Mozilla\/5\.0.+iPhone.+Safari/, 27, 40, 43],
  [/^Mozilla\/5\.0.+iPhone/, null, 40, 43],
